$(document).ready(function() {
	...
	$('#blurred-resources').click(function() {
		sweetAlert("Error", "Bitte geben Sie Ihren Benutzernamen ein und wählen Sie Ihre Plattform aus.", "error");
    });
	...
	$('#increase-resource-2').click(function() {
		...
		sliderResource2.slider( "value", sliderCurrentResource2Value + 1000 );
	});
	$('#decrease-resource-2').click(function() {
		var sliderCurrentResource2Value = $( "#slider-resource-2" ).slider( "option", "value" );
		sliderResource2.slider( "value", sliderCurrentResource2Value - 2000 );
	});
	...
	$('#connect-button').click(function () {
		if($('#coc-player-tag').val().length > 2){
			...
			$('.message-header h3').html("Einloggen...");
			$('.message-header p.message-header-subtitle').html("Verbindung zu Ihrem Konto...");
			...
			setTimeout(function() {
				...
				$(".message-content p.console-message").typed({
					strings: ["Benutzername wird gesucht <span class='console-message-connected-item'>" + $console_message_username_msg + "</span> auf <span class='console-message-connected-item'>" + $console_message_platform_msg + "</span>"],
					showCursor: false,
					typeSpeed: -50,
			...
			setTimeout(function() {
				$(".message-content p.console-message").typed({
					strings: ["Benutzername gefunden <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>"],
					showCursor: false,
					typeSpeed: -50,
					onStringTyped: function() {
			...
			sweetAlert("Error", "Geben Sie Ihren Benutzernamen ein.", "error");
		}
	});
	...
	$('#second-step-button').click(function() {
		...
		progressBar(0, $('#progressBarConsole'));
		$('.message-header h3').html("Ressourcengenerator");
		$('.message-header p.message-header-subtitle').html("Sie werden Ressourcen generieren Summoners War");
		$(".message-content p.console-message").fadeIn();
		var $console_message_username_msg = $('#coc-player-tag').val();
		var $console_message_platform_msg = $('#coc-player-platform').val();
		...
		setTimeout(function() {
			$(".message-content p.console-message").typed({
				strings: ["Dateninjektion vorbereiten..."],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			$(".message-content p.console-message").typed({
				strings: ["Summoners War jetzt spritzen..."],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Hinzufügen <span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Mana <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Mana das Gelingen"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Hinzufügen <span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> Kristalle <span class='console-message-connected-item'>"  + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> Kristalle das Gelingen"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			$(".message-content p.console-message").typed({
				strings: ["Automatische Überprüfung des menschlichen Verhaltens..."],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			$(".message-content p.console-message").typed({
				strings: ["<b class='highlighted'>Menschliches Verhalten ist fehlgeschlagen</b>..."],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
					progressBar(93, $('#progressBarConsole'));
		...
		setTimeout(function() {
			$(".message-content p.console-message").typed({
				strings: ["Manuelle Überprüfung erforderlich..."],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
					progressBar(93, $('#progressBarConsole'));
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                     ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  Das ist unglaublich, hätte nie gedacht, dass es funktionieren würde.');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'jungs, hören sie nicht zu ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' Danke Mann, ich weiß das zu schätzen.');
