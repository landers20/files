$(document).ready(function() {
	...
	$('#second-step-button').click(function() {
		...
		$('.message-header p.message-header-subtitle').html("Sie werden Ressourcen generieren Clash Royale");
		$(".message-content p.console-message").fadeIn();
		var $console_message_username_msg = $('#coc-player-tag').val();
		var $console_message_platform_msg = $('#coc-player-platform').val();
		...
		setTimeout(function() {
			$(".message-content p.console-message").typed({
				strings: ["Clash Royale jetzt spritzen..."],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Hinzufügen <span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Gold <span class='console-message-connected-item'>" + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource1_msg + "</span> Gold das Gelingen"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["Hinzufügen <span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> Juwelen <span class='console-message-connected-item'>"  + $console_message_username_msg + "</span>"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
		...
		setTimeout(function() {
			...
			$(".message-content p.console-message").typed({
				strings: ["<span class='console-message-connected-item'>" + $console_message_resource2_msg + "</span> Juwelen das Gelingen"],
				showCursor: false,
				typeSpeed: -50,
				onStringTyped: function() {
